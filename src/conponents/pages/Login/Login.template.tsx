...
export const LoginTemplate: React.VFC = () => {
  ...
  return (
    <div className="login-content">
      ...
      <TextField id="standard-basic" label="user name" onChange={(ev) => setMyId(ev.target.value)} />
      <TextField id="standard-basic" type="password" label="password" onChange={(ev) => setPassword(ev.target.value)} />
      <TextField id="standard-basic" label="name" onChange={(ev) => setName(ev.target.value)} />
